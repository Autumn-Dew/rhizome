<template>
  <div class="play-stats" :class="{ entered: entered }">
    ...
    <div class="top-section">
      ...
      <div class="song-list">
        <div class="song-item" v-for="(item, idx) in songTop" :key="idx" @dblclick="playSong(item)">
...
.stats-header { padding: 16px; border-bottom: 2px solid var(--border-color); }
.stats-header h2 { font-size: 20px; margin: 0 0 4px; }
.desc { font-size: 12px; opacity: 0.7; }

.stats-summary { display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; padding: 20px; border-bottom: 2px solid var(--border-color); }
...
.section-header { display: flex; justify-content: space-between; align-items: center; margin: 20px 0 0; padding-bottom: 8px; border-bottom: 2px solid var(--border-color); }
...
.stat-card {
  ...
  transition: opacity 0.18s cubic-bezier(0.25, 0, 0, 1),
              transform 0.18s cubic-bezier(0.25, 0, 0, 1);
}
.entered .stat-card { opacity: 1; transform: scaleY(1); }
...
.top-section:nth-child(2) .section-header { transition-delay: 0.34s; }
.top-section:nth-child(3) .section-header { transition-delay: 0.4s; }
...
.song-item:nth-child(1) { transition-delay: 0.38s; }
.song-item:nth-child(2) { transition-delay: 0.408s; }
.song-item:nth-child(3) { transition-delay: 0.436s; }
.song-item:nth-child(4) { transition-delay: 0.464s; }
.song-item:nth-child(5) { transition-delay: 0.492s; }
.song-item:nth-child(6) { transition-delay: 0.52s; }
.song-item:nth-child(7) { transition-delay: 0.548s; }
.song-item:nth-child(8) { transition-delay: 0.576s; }
.song-item:nth-child(9) { transition-delay: 0.604s; }
.song-item:nth-child(10) { transition-delay: 0.632s; }
.song-item:nth-child(11) { transition-delay: 0.66s; }
.song-item:nth-child(12) { transition-delay: 0.688s; }
.song-item:nth-child(13) { transition-delay: 0.716s; }
.song-item:nth-child(14) { transition-delay: 0.744s; }
.song-item:nth-child(15) { transition-delay: 0.772s; }
.song-item:nth-child(16) { transition-delay: 0.8s; }
.song-item:nth-child(17) { transition-delay: 0.828s; }
