  ...
  <div class="rc-player-container" :class="[themeClass]">
    <div class="rc-sub-sidebar">
      ...
      <div class="rc-sub-bottom-group">
        ...
        <button class="rc-sub-func-btn" :class="{ active: isSettingsActive }" @click="goSettings" data-demo-trigger>
          <svg class="rc-sub-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor">
...
/* ── Ornate：侧边栏功能按钮——四边 currentColor 延展（hover 反色沿用 classic） ── */
html[data-motion="ornate"] .rc-sub-func-btn::before {
  content: '';
...
html[data-motion="ornate"] .rc-sub-func-btn:hover::before {
