...
/* ══ Ornate：音量按钮四边 currentColor 延展（子组件内部需各自声明） ══ */
html[data-motion="ornate"] .rc-volume-btn { position: relative; }
html[data-motion="ornate"] .rc-volume-btn::before {
  content: '';
...
html[data-motion="ornate"] .rc-volume-btn:hover::before {
